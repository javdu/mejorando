            ...
            <div class="col-xs-8 col-lg-offset-2">
                <form name="poblacionForm" id="poblacionForm">
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><h5>¿Puede caminar sobre una línea recta?</h5></div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><h5>¿Puede recortar figuras con tijera para niños?</h5></div>
                      <div class="panel-body">
                            <div class="radio text-center">
                                <div class="row">
                                    <div class="col-xs-4"><label><input type="radio" name="optradio">Siempre</label></div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><h5>¿Puede lavarse las manos sin ayuda?</h5></div>
                      <div class="panel-body">
                            <div class="radio text-center">
                                <div class="row">
                                    <div class="col-xs-4"><label><input type="radio" name="optradio">Siempre</label></div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><h5>¿Puede abrochar un botón?</h5></div>
                      <div class="panel-body">
                            <div class="radio text-center">
                                <div class="row">
                                    <div class="col-xs-4"><label><input type="radio" name="optradio">Siempre</label></div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><h5>¿Puede guardar solo sus cosas en su mochila?</h5></div>
                      <div class="panel-body">
                            <div class="radio text-center">
                                <div class="row">
                                    <div class="col-xs-4"><label><input type="radio" name="optradio">Siempre</label></div>
